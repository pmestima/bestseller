...
class DiscountRule3Test {

    @InjectMocks
    private DiscountRule3 discountRule3 = new DiscountRule3();
    ...
    void shouldReturn3ProductsTest() {
        ...
        cart.addProduct(new ProductEntity(UUID.randomUUID(), drink, List.of(topping), 1));
        double discount = discountRule3.calculateDiscount(cart);
